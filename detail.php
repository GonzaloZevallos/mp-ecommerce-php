...
// notification_url
$preference->notification_url = $url . "/notifications.php?source_news=webhooks";
                            ...
                            <div class="width:60%">
                                        ...
                                        <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                            <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="6|Powerbeats3 Wireless Earphones - Neighborhood Collection - Brick Red|MPXP2">
                                                <div class="as-tilegallery-element as-image-selected">
                                                    <div class=""></div>
                                                    <img src="./assets/003.jpg" class="ir ir item-image as-producttile-image" alt="" width="445" height="445" style="content:-webkit-image-set(url(<?= $_POST['img'] ?>) 2x);">
                                                </div>
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <a href="<?= $preference->init_point; ?>">
                                        <button class="mercadopago-button">
                                            Pagar la compra                                    
                                        </button>
                                    </a>
                                </div>
